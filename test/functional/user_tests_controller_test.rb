...
class UserTestsControllerTest < ActionController::TestCase
  ...
  test "should create user_test" do
    assert_difference('UserTest.count') do
      post :create, user_test: { answer_id: @user_test.answer_id, question_id: @user_test.question_id, user_id: @user_test.user_id }
    end
  ...
  test "should update user_test" do
    put :update, id: @user_test, user_test: { answer_id: @user_test.answer_id, question_id: @user_test.question_id, user_id: @user_test.user_id }
    assert_redirected_to user_test_path(assigns(:user_test))
  end
